...
void add()
{
    ...
    for(int i=0;i<=1000000;i++){//out(nod(i));
        if(i==0){
            a[0]=1;
            continue;
        }
...
int main()
{
    ...
    while(t--){
      int x,y;
      sii(x,y);
      int l = lower_bound(a,a+1000000,x)-a;
      int h;
      if(binary_search(a,a+1000000,y)){
          h = lower_bound(a,a+1000000,y)-a;
      }
      else {
        h = lower_bound(a,a+1000000,y)-a-1;
      }
